...
angular.module('gc.dateRangeFiltersDirective', [
  ...
  'app/shared/components/date-range-filters/date-range-filters-template.html'
]).directive('dateRangeFilters', function dateRangeFiltersDirective() {
  return {
    restrict: 'E',
    replace: true,
    templateUrl: 'app/shared/components/date-range-filters/' +
                 'date-range-filters-template.html',
    scope: {
      filters: '='
    }
  };
...
angular.module('date-range-filters-template.html', []).run(function($templateCache) {
  $templateCache.put('date-range-filters-template.html',
